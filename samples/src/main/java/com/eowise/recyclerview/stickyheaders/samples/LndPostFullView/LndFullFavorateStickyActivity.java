...
public class LndFullFavorateStickyActivity extends AppCompatActivity {
...
//for header
        ...
        mAdapter = new LndHomeAdapter(this, mHeaderDisplay, Favorates.mItems);
