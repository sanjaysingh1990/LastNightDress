...
public class CustomCameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CustomCameraPreview(Context context, Camera camera) {
        ...
        try {
            ...
            Log.e("sizes",mSupportedPreviewSizes.size()+"");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        try {
            ...
            if (mSupportedPreviewSizes != null) {
                ...
                Toast.makeText(getContext(),"Camera not responding",Toast.LENGTH_SHORT).show();
            }
            ...
            if (CameraPreviewFragment.current_camera_id == com.eowise.recyclerview.stickyheaders.samples.define.Camera.CAMERA_BACK) {
