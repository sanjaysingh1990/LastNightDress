   ...
   private Context context;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            Log.e("prefix", mPrefix);
            Log.e("postfix", mSuffix);
    ...
    private CharSequence getRelativeTimeDisplayString() {
        ...
        String value= (difference >= 0 &&  difference<=DateUtils.MINUTE_IN_MILLIS) ?
                getResources().getString(R.string.just_now): ;
Log.e("values",value+"");*/
        return new TimeAgo(context).timeAgo(mReferenceTime);
    }
