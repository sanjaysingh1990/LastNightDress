...
public class NumberedAdapter2 extends RecyclerView.Adapter {
    ...
    private ShopData lastitem;

    public NumberedAdapter2(ArrayList<ShopData> sd, Activity con, RecyclerView recyclerView, Context context) {
    ...
    public NumberedAdapter2(ArrayList<ShopData> sd, Activity con) {
