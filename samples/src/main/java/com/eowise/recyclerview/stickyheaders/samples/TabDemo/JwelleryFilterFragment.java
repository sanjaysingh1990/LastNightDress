 ...
 * 
 */
public class JwelleryFilterFragment extends Fragment implements View.OnClickListener {
	...
	int jewellery[] = new int[]{0, 0, 0, 0, 0, 0, 0, 0};
	...
	String[] jewellerytypelist = new String[]{"", "", "", "", ""};
	int biss1 = 0, biss2 = 0, bissll = 0;
