...
public class ShoesFilterFragment extends Fragment implements View.OnClickListener {
    ...
    static String[] shoetypelist = new String[]{"", "", "", "", "", "", "", ""};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LndShopActivity.filterselected = 3;
        ...
        //condition listener
        for (int i = 0; i < shoecondition.size(); i++) {
            shoecondition.get(i).setOnClickListener(this);
        }
...
//shoe size
        ...
        size[shoesize.size() - 1] = 0;
        //shoe condition
        for (int i = 0; i < shoecondition.size() - 1; i++) {
            shoecondition.get(i).setBackgroundColor(Color.parseColor("#1d1f21"));
            conditionlist[i] = "";
            condition[i] = 0;
        }
        condition[shoecondition.size() - 1] = 0;
        //color reset
...
//condition events
            ...
            case R.id.conditionall:
                if (condition[2] == 0) {
                    ...
                    shoecondition.get(0).setBackgroundColor(Color.parseColor("#be4d66"));
                    shoecondition.get(1).setBackgroundColor(Color.parseColor("#be4d66"));
                    ...
                    shoecondition.get(0).setBackgroundColor(Color.parseColor("#1d1f21"));
                    shoecondition.get(1).setBackgroundColor(Color.parseColor("#1d1f21"));
