...
public class OtherUserProfileActivity extends Activity {
    ...
    @Bind(R.id.totalswaps)TextView totalswaps;
    ...
    @Bind(R.id.userfollow)TextView followunfollow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(data!=null) {
            profileuname = data.getString("uname");
        ...
        getData(userid);
        getPorfile(ImageLoaderImage.pref.getString("user_id",""),userid);
    }
      ...
      /*  adapter.setOnClickEvent(new ParallaxRecyclerAdapter.OnClickEvent() {
       ...
       message.setOnClickListener(new View.OnClickListener() {
        ...
        followunfollow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                followunfollow(userid, ImageLoaderImage.pref.getString("user_id", ""));
            }
        });
...
//to go following page
    ...
    public  void getPorfile(final String followerid,final String followingid){
