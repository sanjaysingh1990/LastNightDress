...
public class ItemAccepted extends LndBaseActivity {
    ...
    private void editRating(final String orderid) {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, ApplicationConstants.APP_SERVER_URL_LND_SHIPPINGINFO, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("status")) {
                        ...
                        Toast.makeText(ItemAccepted.this, "some thing went wrong", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                try {
                    new com.eowise.recyclerview.stickyheaders.samples.AlertDialog().showAlertDialog(ItemAccepted.this);
                } catch (Exception ex) {
